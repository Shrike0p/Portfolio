    ...
    return (
        <div className="relative w-full h-screen overflow-hidden">
            ...
            {showBackground && (
                ...
                >
                    <Background className="w-full h-full opacity-0 md:opacity-100" />
                </motion.div>
            )}
            ...
            <div className=" w-full min-h-[80vh] flex flex-col justify-between px-6 lg:px-32 pt-32 lg:pt-36">
                {animationPhase >= 2 && (
                    <div className="absolute inset-0 flex items-start justify-between px-12 lg:px-32 pt-32 lg:pt-36 z-20">
                        ...
                        >
                            <h2 className="text-3xl lg:text-6xl font-bold text-white mb-2">
                                Hello, I &apos; m
                            </h2>
                            <h1 className="text-3xl lg:text-7xl font-bold text-white mt-4 mb-6">
                                <TypeAnimation
                                    sequence={[
                            ...
                            <div className="mt-4 mb-10">
                                <TypeAnimation
                                    ...
                                    wrapper="p"
                                    speed={50}
                                    className="text-gray-300 text-sm lg:text-xl max-w-2xl"
                            ...
                            >
                                <motion.button
                                    className=" px-3 py-2 lg:px-6 lg:py-3 bg-gray-800 text-white font-medium rounded-lg hover:bg-gray-700 transition-colors flex items-center"
                                ...
                                >
                                    <a href="https://drive.google.com/file/d/1tmSLyzSco6W2Z7qi8fwmQOvm5f8-lxCZ/view?usp=sharing" target="_blank" className="text-white hover:text-gray-300 transition-colors">
                                        <span className="text-sm lg:text-base font-bold"> View CV</span>
                                    </a>
                                </motion.button>
                                <motion.div
